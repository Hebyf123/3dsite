    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(blank=True, max_length=80, null=True, verbose_name='Фамилия')),
                ...
                ('country', models.CharField(blank=True, max_length=255, null=True, verbose_name='Старана')),
                ('city', models.CharField(blank=True, max_length=255, null=True, verbose_name='Город')),
                ('Addres', models.CharField(blank=True, max_length=255, null=True, verbose_name='Адрес')),
